...
class AlternativeStockMatcher:
                ...
                try:
                    ...
                    if result:
                        ...
                        update_params.append((
                            ...
                            json.dumps(result['alt_reasons'], ensure_ascii=False),
                            sell_stock['symbol'],
                            analysis_date
                        ))
                    else:
    ...
    async def match_single_stock(self, symbol: str, analysis_date) -> bool:
        ...
        try:
            ...
            if sell_stock['final_grade'] not in ('매도', '매도 고려'):
    ...
    async def _update_alternative(
        ...
        try:
            ...
            await self.db_manager.execute_query(
                ...
                alt_final_score,
                alt_match_type,
                json.dumps(alt_reasons, ensure_ascii=False),
                symbol,
                analysis_date
            )
            return True
